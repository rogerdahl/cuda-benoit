...
{
  float pos_;
  StaticSpatialPaletteKey
      spatial_palette_keys_[MAX_SPATIAL_KEYS + 2 /* virtual keys */];
};

struct StaticTemporalPalette
{
  StaticTemporalPaletteKey
      temporal_palette_keys_[MAX_TEMPORAL_KEYS + 2 /* virtual keys */];
};
