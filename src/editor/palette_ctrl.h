...
class WXDLLEXPORT TemporalPaletteCtrl : public wxControl
{
  ...
  void RenderSlider(
      wxDC& dc, bool focus, const wxRect& rect, const Pos& pos, const Color& c);
...
#define EVT_PALETTE_HASCHANGED(id, fn)                                  \
  DECLARE_EVENT_TABLE_ENTRY(                                            \
      wxEVT_PALETTE_HASCHANGED, id, -1,                                 \
      (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)( \
          PaletteEventFunction)&fn,                                     \
      (wxObject*)NULL)                                                  \
  ,
